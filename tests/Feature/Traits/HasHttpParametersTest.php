...
class HasHttpParametersTest extends TestCase
{
    public function test_can_fetch_correct_body_parameters(): void
    {
        ...
        /** @var \App\Models\WorkflowAction $serviceAction */
        $workflowAction = WorkflowAction::factory()
            ->createOne(['body_parameters' => self::oneHiddenOneNotHiddenParameters()]);
        ...
        $this->assertEqualsCanonicalizing(
            ...
            actual : $workflowAction->body_parameters_for_api,
        );

        $serviceAction->updateQuietly(['body_parameters' => self::bothNotHiddenParameters()]);
        $workflowAction->updateQuietly(['body_parameters' => self::bothNotHiddenParameters()]);
        $this->assertEqualsCanonicalizing(
            expected: [
                [
                    'parameter_name' => 'User Email',
        ...
        $workflowAction->updateQuietly(['body_parameters' => self::bothHiddenParameters()]);
        $this->assertEmpty($serviceAction->body_parameters_for_api);
        $this->assertEmpty($workflowAction->body_parameters_for_api);
    }
    ...
    public function test_can_fetch_correct_query_parameters(): void
    {
        ...
        $this->assertEqualsCanonicalizing(
            ...
            actual : $workflowAction->query_parameters_for_api,
        );

        $serviceAction->updateQuietly(['query_parameters' => self::bothNotHiddenParameters()]);
        $workflowAction->updateQuietly(['query_parameters' => self::bothNotHiddenParameters()]);
        $this->assertEqualsCanonicalizing(
            expected: [
                [
                    'parameter_name' => 'User Email',
        ...
        $workflowAction->updateQuietly(['query_parameters' => self::bothHiddenParameters()]);
        $this->assertEmpty($serviceAction->query_parameters_for_api);
        $this->assertEmpty($workflowAction->query_parameters_for_api);
    }
    ...
    public function test_can_fetch_correct_url_parameters(): void
    {
        ...
        $this->assertEqualsCanonicalizing(
            ...
            actual : $workflowAction->url_parameters_for_api,
        );

        $serviceAction->updateQuietly(['url_parameters' => self::bothNotHiddenParameters()]);
        $workflowAction->updateQuietly(['url_parameters' => self::bothNotHiddenParameters()]);
        $this->assertEqualsCanonicalizing(
            expected: [
                [
                    'parameter_name' => 'User Email',
        ...
        $workflowAction->updateQuietly(['url_parameters' => self::bothHiddenParameters()]);
        $this->assertEmpty($serviceAction->url_parameters_for_api);
        $this->assertEmpty($workflowAction->url_parameters_for_api);
    }
